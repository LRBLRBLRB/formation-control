...
set(MSG_I_FLAGS "-Iaruco_detection:/home/aemc4/catkin_ws_multirobot/src/aruco_detection/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/aemc4/catkin_ws_multirobot/src/aruco_detection/msg/aruco_info.msg" NAME_WE)
add_custom_target(_aruco_detection_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "aruco_detection" "/home/aemc4/catkin_ws_multirobot/src/aruco_detection/msg/aruco_info.msg" "std_msgs/Header:geometry_msgs/Point"
)
...
_generate_msg_cpp(aruco_detection
  "/home/aemc4/catkin_ws_multirobot/src/aruco_detection/msg/aruco_info.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aruco_detection)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aruco_detection\")")
  # install generated code
  install(
